...
[Migration("20260126120929_MembershipDateFix")]
partial class MembershipDateFix
{
    /// <inheritdoc />
...
#pragma warning disable 612, 618
        ...
        modelBuilder.Entity("PureGym.Domain.Entities.ApplicationUser", b =>
            {
                b.Property<Guid>("Id")
                    .ValueGeneratedOnAdd()
                    .HasColumnType("uuid");
        ...
        modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
            {
                b.HasOne("PureGym.Domain.Entities.ApplicationUser", null)
                    .WithMany()
        ...
        modelBuilder.Entity("PureGym.Domain.Entities.Member", b =>
            {
                b.HasOne("PureGym.Domain.Entities.ApplicationUser", "User")
                    .WithOne("Member")
                    .HasForeignKey("PureGym.Domain.Entities.Member", "UserId")
